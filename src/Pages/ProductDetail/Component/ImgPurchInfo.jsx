...
class ImgPurchInfo extends Component {
  ...
  render() {
    ...
    return (
      <div className={this.props.newClassName}>
        <div className='ImgPurchInfo'>
            ...
            <div className='smallReviewRatings'>
              <div>
                ...
                <span className='reviewCount'>
                  {reviewArray && reviewArray.length}
                </span>
              </div>
              <div>
                <span className='smallCount'>
                  ...
                  {reviewArray.length > 0 &&
                    (
                      reviewArray.reduce((acc, curr) => acc + curr) /
                      reviewArray.length
                    ).toFixed(1)}{' '}
                  /5
                </span>
          ...
          <div className='purchInfo'>
            <div className='nameAndPrice'>
              ...
              <div className='priceContainer'>
                <span className='priceNumber'>
                  {this.numbersWithComma(Math.floor(price))}
                </span>
            ...
            <div className='sizeButton'>
              <button className='size' onClick={this.handleClick}>
                사이즈
                <i className='fas fa-angle-down'></i>
              </button>
              <button
                className={sizeBtn ? 'singleItemHide' : 'singleItemShow'}
              ...
              <div className='CalTotal'>
                ...
                <div className='btnPriceContainter'>
                  <div className='quantBtns'>
                    <button className='minusplus' onClick={this.minusCount}>
                      -
                    </button>
                    <input
                      type='number'
                    ...
                    />
                    <button className='minusplus' onClick={this.plusCount}>
                      +
                    </button>
                  </div>
            ...
            <div className='PurchCartButtons'>
              <div className='totalQP'>
                ...
                <span className='totQuantity'>
                  총 수량 {count}개 |
                  <span className='totPrice'>
                    {' '}
                    {this.numbersWithComma(price * count)}원
                  </span>
                </span>
              </div>
